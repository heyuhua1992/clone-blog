<template>
  <div id="slider">
    <div class="window" @mouseover="stop" @mouseleave="play">
      ...
      <ul class="direction">
        <li class="left" @click="move(300, 1, speed)">
        ...
        <li class="right" @click="move(300, -1, speed)">
...
export default {
  ...
  data () {
    return {
      sliders:[
        {
          img:'../../static/slider/1.jpg'
        },
        {
          img:'../../static/slider/2.jpg'
        },
        {
          img:'../../static/slider/3.jpg'
        },
        {
          img:'../../static/slider/4.jpg'
        },
        {
          img:'../../static/slider/5.jpg'
        }
      ],
      currentIndex:1,
      distance:-300,
  ...
  methods:{
    ...
    move(offset, direction, speed) {
      ...
      direction === -1 ? this.currentIndex += offset/300 : this.currentIndex -= offset/300
    ...
    animate(des, direc, speed) {
      ...
      this.temp = window.setInterval(() => {
        if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
          ...
          window.clearInterval(this.temp)
          this.distance = des
          if (des < -1500) this.distance = -300
          if (des > -300) this.distance = -1500
        }
      }, 20)
    },
    jump(index) {
      const direction = index - this.currentIndex >= 0 ? -1 : 1
      const offset = Math.abs(index - this.currentIndex) * 300
